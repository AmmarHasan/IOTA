    ...
    var DrawTool =
{
    ...
    function DrawIt(drawObject, syncServer) {
        ...
        if (syncServer && drawObject.Tool != DrawTool.Pencil && drawObject.Tool != DrawTool.ClearBoard) {
    ...
    tools.clear = function () {
        this.mousedown = function (ev) {
            ...
            if (yes) {
                ...
                //img_update();
                var message = "clearboard";
                if (whiteboardHub != null)

                    whiteboardHub.server.clearBoard($("#sessinId").val(), $("#groupName").val(), $("#hdnUserName").val());
