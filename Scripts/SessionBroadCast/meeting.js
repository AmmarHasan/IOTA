    ...
    window.Meeting = function (channel) {
        ...
        function captureUserMedia(callback) {
            ...
            function onstream(stream) {
                ...
                callback(stream);
                $('.instructions').hide();
                document.getElementById('setup-new-meeting').disabled =true;
                document.getElementById('setup-new-meeting').style.opacity = '0.7';
            ...
            function onerror(e) {
                console.log(e);
                alertify.error('<h4>Failed to get hardware access!</h4> Do you have another browser type open and using your cam/mic <b>or</b> harware access is denied by you?');
