        ...
        function prepareInit(callback) {
            if (!self.openSignalingChannel) {
                ...
                self.openSignalingChannel = function (config) {
                    ...
                    //   var firebase = new Firebase('https://' + (self.firebase || 'chat') + '.zarm.com/' + channel);
                ...
                if (!window.Firebase) {
                    loadScript('firebase.js', callback);
                } else
                    callback();
            } else
                callback();
                ...
                var mediaConfig = {
                    ...
                    onerror: function () {
                        ...
                        if (session.audio && !session.video) {
                            ...
                            alertify.error('<h4>Failed to get hardware access!</h4> Do you have another browser type open and using your cam/mic?<br/><br/>Actual Error: ' + JSON.stringify(error));
                            ...
                            alertify.error('<h4>Failed to get hardware access!</h4> Do you have another browser type open and using your cam/mic?<br/>Actual Error: ' + JSON.stringify(error));
